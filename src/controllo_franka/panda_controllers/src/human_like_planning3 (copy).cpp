...
int main(int argc, char **argv)
{
    ...
    ros::Publisher pub_pose1 = node.advertise<geometry_msgs::PoseStamped>("/combined_panda/force_panda1/equilibrium_pose", 1);
    ros::Publisher pub_pose2 = node.advertise<geometry_msgs::PoseStamped>("/combined_panda/force_panda2/equilibrium_pose", 1);
    ...
    ros::Subscriber robot_pose_sub1 = node.subscribe("/combined_panda/force_panda1/franka_ee_pose", 1, robotPoseCallback_pd_1);
    ros::Subscriber robot_pose_sub2 = node.subscribe("/combined_panda/force_panda2/franka_ee_pose", 1, robotPoseCallback_pd_2);

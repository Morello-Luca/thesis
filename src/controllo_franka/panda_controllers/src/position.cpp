...
int main(int argc, char **argv)
    {
        ...
        // Pubisher pandas
                ...
                // force
                        pub_force_panda1 = node_handle.advertise<geometry_msgs::Vector3Stamped>("/combined_panda/cartesian_impedance_example_controller1/desired_force", 1);
                        pub_force_panda2 = node_handle.advertise<geometry_msgs::Vector3Stamped>("/combined_panda/cartesian_impedance_example_controller2/desired_force", 1);
